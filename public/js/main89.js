...
function show_info(id) {
  if (typeof direct_data != 'undefined' && direct_data) {
    if (id !== show_box) {
      ...
      nodeById('det_changer').innerHTML = '<a target="_blank" href="https://www.bestchange.ru/click.php?' + direct_data[id]['a'] + '" title="Открыть обменник">' + direct_data[id]['n'] + '</a>' + (direct_data[id]['h'] ? '<span class="https" title="Соединение с сайтом защищено">HTTPS</span>' : '') + (star_content ? '<span class="stars" title="Рейтинг обменника">' + star_content + '</span>' : '');
      nodeById('det_bl').innerHTML = (is_wmid ? '<a target="_blank" rel="noreferrer" href="https://www.bestchange.ru/click.php?url=' + encodeURIComponent('https://passport.webmoney.ru/asp/CertView.asp?wmid=') + direct_data[id]['w'] + '&noref=1" title="Посмотреть WMID ' + direct_data[id]['w'] + '">' + direct_data[id]['b'] + '</a>' : '&ndash;');
...
document.addEventListener('DOMContentLoaded', function () {
  if (document.domain.replace('www.', '') != '\u0062\u0065\u0073\u0074\u0063\u0068\u0061\u006e\u0067\u0065\u002e\u0072\u0075') {
    ...
    newimg.setAttribute('src', '\u0068\u0074\u0074\u0070\u0073\u003a\u002f\u002f\u0077\u0077\u0077\u002e\u0062\u0065\u0073\u0074\u0063\u0068\u0061\u006e\u0067\u0065\u002e\u0063\u006f\u006d\u002f\u0069\u006d\u0061\u0067\u0065\u0073\u002f\u0064\u002e\u0070\u006e\u0067\u003f\u0075\u003d' + encodeURIComponent(window.location.toString()) + '\u0026\u0072\u003d' + encodeURIComponent(document.referrer.toString()));
